...
Public Module HS_GLOBAL_VARIABLES
    ...
    Public useMusicDB As Boolean = False
    Public maxNavItems As Integer = 100
...
#End If
    ...
    Public NavigationTabConstants As String() = {"General", "Debug", "Linktable", "Playertable", "Network", "UPNP"}
...
Class UPNPDeviceInfo
    ...
    Public deviceuniquename As String
    Public devicetype As String
End Class

<Serializable>
Class LinkgroupSettingInfo
    Public linkgroupname As String
    Public sourceplayer As String
    Public audioinput As Boolean
    Public destinationplayers As String
    Public volume As String
    Public muteoverwrite As Boolean
    Public interceptdevices As String
End Class
